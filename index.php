...
if($res){
    ...
    if(isset($_POST['submit'])){
        ...
        $q2 = "SELECT * FROM brackets";
        $res2 = mysqli_query($connection, $q);
if($res2){
    $id = mysqli_num_rows($res) + 1;
}
$q = "INSERT INTO `brackets` (`id`, `fname`, `lname`, `email`, `name`, `paid`, `points`, `201`, `202`, `203`, `204`, `205`, `206`, `207`, `208`, `209`, `210`, `211`, `212`, `213`, `214`, `215`, `216`, `217`, `218`, `219`, `220`, `221`, `222`, `223`, `224`, `225`, `226`, `227`, `228`, `229`, `230`, `231`, `232`, `301`, `302`, `303`, `304`, `305`, `306`, `307`, `308`, `309`, `310`, `311`, `312`, `313`, `314`, `315`, `316`, `401`, `402`, `403`, `404`, `405`, `406`, `407`, `408`, `501`, `502`, `503`, `504`, `601`, `602`, `701`, `timestamp`) VALUES ('" . $id . "', '" . $fname . "', '" . $lname . "', '" . $email . "', '" . $name . "', '0' , '" . $points. "', ";
       for( $i = 201; $i <=232; $i++){
            $q .= "'" . $picks[$i] . "', ";
        }
        for( $i = 301; $i <=316; $i++){
...
<body>
    <div class="header">
        ...
        <ul>
            <li id="noborder"><a href="#">Home</a></li>
            <li><a href="#">Rules & Scoring</a></li>
            <li><a href="#">Standings</a></li>
            <li><a href="#">Submitted Brackets</a></li>
        </ul>
    </div>
    <div class="information">
        <h4>Fill out your bracket below.</h4>
        <h5>Please make sure to read the <a href="info.php">rules & scoring guidelines</a> before submitting a bracket</h5>
    </div>
    <div class="bracket">
               <form action="index.php" method="post">
               <input type="text" placeholder="First Name" name="fname" id="fname" onchange="checkFilled(slots)">
               <input type="text" placeholder="Last Name" name="lname" id="lname" onchange="checkFilled(slots)">
               <input type="email" placeholder="Email" name="email" id="email" onchange="checkFilled(slots)">
        <input type="text" placeholder="Name your bracket..." name="name" id="name"  onchange="checkFilled(slots)">
    ...
    <script>
        ...
        $(".team").on("click", function() {
            ...
            console.log(nextID);
            if (nextID % 2 == 1) {
                $("#" + nextID).html("<h3 class='seed1' style='background-color: " + teamColor + "'>" + teamSeed + "</h3><p class='teamname'>" + teamName + "</p>");
            } else {
                $("#" + nextID).html("<h3 class='seed2' style='background-color: " + teamColor + "'>" + teamSeed + "</h3><p class='teamname'>" + teamName + "</p>");
            }
            $("#i" + nextID).val(teamID);
            checkValidity(slots);
            checkFilled(slots);
        ...
        function checkValidity(slots) {
            //start with highest round, check to make sure same ID exists in previous round

            var error;
            for (var i = 301; i <= 316; i++) {
                if (typeof slots[i] != 'undefined') {
                    //filled in, now backcheck
                    var count = 0;
                    for (var j = 201; j <= 232; j++) {
                        if (typeof slots[j] != 'undefined') {
                            if (slots[j].id == slots[i].id) {
                                count++;
                            }
                        }
                    }
        ...
        function checkFilled(slots) {
            ...
            if(!$("#points").val()){
                error = 1;
                console.log("points not filled in");
            }
            if(!$("#name").val()){
                error = 1;
            ...
            if(error == 1){
                ...
                $("#submit").css("background-color", "#11b571");
            }
        }
